...
TRAJ_FILE = "/results/results_cma_es_pop_32_gen_100_circular_0/run_02120_SUCCESS_S0.4987_C0.3097_X0.2451.npz"
...
for i in range(num_evals):
    ...
    run_result = {
        ...
        'rmse': RMSE,
        'cost': cost_adjusted,
        'gate_dist': dist_to_gate,
        'is_success': gate_success,
        'noise': {
...
np.savez_compressed("evaluation_nominal_horizontalhairpin.npz", **save_dict)
print(f"\nSuccessfully saved!")